...
require (
	...
	github.com/pingcap/parser v0.0.0-20201014065806-ed8f289fd368
...
replace github.com/pingcap/parser => github.com/tiancaiamao/parser v0.0.0-20201014151657-1a37295dcc2b
